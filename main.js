...
function el03(){
  ...
  var cookieJson = Cookies.getJSON('id');
  Cookies.set('id', { name: $('#name').val(), pickedAvatar: true, avatar: '1', e: cookieJson.e + 1, h: cookieJson.h, o: cookieJson.o, s: cookieJson.s, a: cookieJson.a, lockout: date.getTime() + 86400000 });
  $('#firstz').hide();
  $('#firste').show();
  $('#firsth').hide();
  $('#firsto').hide();
...
function ha03(){
  var cookieJson = Cookies.getJSON('id');
  Cookies.set('id', { name: $('#name').val(), pickedAvatar: true, avatar: '1', e: cookieJson.e, h: cookieJson.h + 1, o: cookieJson.o, s: cookieJson.s, a: cookieJson.a, lockout: date.getTime() + 86400000 });
  $('#firstz').hide();
  $('#firste').hide();
  $('#firsth').show();
  $('#firsto').hide();
...
function ok03(){
  var cookieJson = Cookies.getJSON('id');
  Cookies.set('id', { name: $('#name').val(), pickedAvatar: true, avatar: '1', e: cookieJson.e, h: cookieJson.h, o: cookieJson.o + 1, s: cookieJson.s, a: cookieJson.a, lockout: date.getTime() + 86400000 });
  $('#firstz').hide();
  $('#firste').hide();
  $('#firsth').hide();
  $('#firsto').show();
...
function sa03(){
  var cookieJson = Cookies.getJSON('id');
  Cookies.set('id', { name: $('#name').val(), pickedAvatar: true, avatar: '1', e: cookieJson.e, h: cookieJson.h, o: cookieJson.o, s: cookieJson.s + 1, a: cookieJson.a, lockout: date.getTime() + 86400000 });
  $('#firstz').hide();
  $('#firste').hide();
  $('#firsth').hide();
  $('#firsto').hide();
...
function an03(){
  var cookieJson = Cookies.getJSON('id');
  Cookies.set('id', { name: $('#name').val(), pickedAvatar: true, avatar: '1', e: cookieJson.e, h: cookieJson.h, o: cookieJson.o, s: cookieJson.s, a: cookieJson.a + 1, lockout: date.getTime() + 86400000 });
  $('#firstz').hide();
  $('#firste').hide();
  $('#firsth').hide();
  $('#firsto').hide();
